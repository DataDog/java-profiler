...
enum JfrType {
  ...
  T_MALLOC = 127,
  T_NATIVE_SOCKET = 128,
  // Reference-chain engine events: a reconstructed referrer chain, and a
  // search abandoned before reaching a target. See jfrMetadata.cpp.
  T_REFERENCE_CHAIN = 129,
  T_REFERENCE_CHAIN_ABANDONED = 130,
  T_ANNOTATION = 200,
  T_LABEL = 201,
  T_CATEGORY = 202,
  T_TIMESTAMP = 203,

 ...
 * https://tttapa.github.io/Pages/Arduino/Control-Theory/Motor-Fader/PID-Cpp-Implementation.html
 */
class PidController {
private:
  u64 _target;
...
public:
  PidController(u64 target_per_second, double proportional_gain,

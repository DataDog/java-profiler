...
/**
 * Runs the park TaskBlock assertions through HotSpot's delegated RequestStackTrace path.
 */
public class JvmtiBasedParkTaskBlockTest extends ParkTaskBlockTest {
    @Override
